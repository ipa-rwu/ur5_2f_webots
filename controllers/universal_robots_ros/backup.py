...
class TrajectoryFollower(object):
    ...
    def __init__(self, robot, jointStatePublisher, jointPrefix,gripperjointStatePublisher, gripperjointPrefix, goal_time_tolerance=None):
        ...
        self.prefixedGripperJointNames = [s + self.gripperjointPrefix for s in TrajectoryFollower.GripperJointNames]               
        self.gripperjointStatePublisher = gripperjointStatePublisher         
        self.grippermotors = []
        self.grippersensors = []            
